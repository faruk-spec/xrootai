...
<head>
    ...
    <title>Verification Success - {{ \App\Models\SystemSetting::get('general_chatbot_name', 'XrootAI') }}</title>
...
<body x-data="{ darkMode: localStorage.getItem('darkMode') === 'true' }" :class="{ 'dark-mode': darkMode }">
    ...
    <div class="auth-container">
        <div class="clay-card auth-card text-center" style="max-width: 460px; padding: 40px 30px;">
            <div style="width: 76px; height: 76px; border-radius: 50%; background: rgba(34, 197, 94, 0.15); color: #22c55e; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; font-size: 2.4rem;">
                🎉
            </div>
            ...
            <a href="{{ route('chat') }}" class="clay-btn clay-btn-primary" style="display: block; width: 100%; padding: 14px; text-decoration: none; font-size: 1.05rem; text-align: center;">
